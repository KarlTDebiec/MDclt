...
def add_parser(subparsers, *args, **kwargs):
    ...
    **Arguments:**
    ...
    arg_groups["input"].add_argument("-infiles", type = str, required = True, nargs = "*",
...
class Block_Generator(Block_Generator):
    ...
    def __init__(self, output, dataset_kwargs = dict(chunks = True, compression = "gzip"), attrs = {},
        force = False, **kwargs):
        """
        ...
        **Arguments:**
        ...
        .. todo:
            ...
            - Allow specification of where attrs should be stored, so that it is not necessary to override this
              method for this basic feature
        """
        ...
        with h5(out_path) as out_h5:
            if out_address in out_h5:
                if force:
                    ...
                    out_h5.create_dataset(out_address, data = np.empty(self.expected_shape, self.dtype),
                      **dataset_kwargs)
                else:
